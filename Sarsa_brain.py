...
class SARSA:
    ...
    def choose_action(self, location):
        ...
        if np.random.rand() < self.greedy:
            ...
            # Transform the data into the form of[(action,value), (action,value), (action,value), (action,value)]
            # The last element in the key_value list is the last one.
            # If value of the last two is the same, add two actions into the action_list.
            ...
            if key_value[3][1] == key_value[2][1]:
                ...
                if key_value[2][1] == key_value[1][1]:
                    ...
                    # If value of the last three is the same, add two actions into the action_list.
                    if key_value[1][1] == key_value[0][1]:
                        action_list.append(key_value[0][0])
                        # If value of the last four is the same, add two actions into the action_list.
        else:
